...
pub trait Push<B: Spectator>: P<char> + P<B> {
...
#[derive(Debug, Clone)]
pub struct Parser<B: Spectator, I: Push<B>> {
...
impl<B: Spectator, I: Push<B>> Parser<B, I> {
...
impl<B: Spectator, I: Push<B>> crate::Parse for Parser<B, I> {
...
impl<B: Spectator, I: Push<B>> P<char> for Parser<B, I> {
...
impl<B: Spectator, I: Push<B> + Flush> Flush for Parser<B, I> {
...
{
    const OPEN: char = <I as Push<T>>::OPEN;
    const CLOSE: char = <I as Push<T>>::CLOSE;
